      ...
      <div className="container mx-auto max-w-4xl bg-white p-8 shadow-lg rounded-lg">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between mb-8">
          ...
          <div className="flex flex-col lg:flex-row space-x-0 lg:space-x-4 mt-4 lg:mt-0">
            ...
            <Link to="/admin/reports">
              <button className="btn btn-outline btn-secondary mt-2 lg:mt-0">Reports</button>
            </Link>
            <button className="btn btn-error mt-2 lg:mt-0" onClick={handleLogout}>Logout</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-inner">
            ...
            <p><strong>Phone:</strong> +91 {admin.phone}</p>
        ...
        {/* Optional Account Settings (uncomment if needed) */}
        {/* <div className="mt-8">
