...
export const adminCreateProducts = async (data) => {
  try {
...
const AdminCreateProduct = () => {
  ...
  const handleCreateProduct = async (data) => {
    try {
      ...
      const response = await adminCreateProducts(formData);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-800 via-purple-800 to-indigo-900 text-white flex items-center justify-center">
      <div className="bg-gray-900 p-8 rounded-lg shadow-xl w-full max-w-xl">
        <h2 className="text-4xl font-bold text-center mb-6">Create New Product</h2>
        <form
          className="space-y-5"
        ...
        >
          ...
          <div className="form-control">
            ...
            <input
              ...
              className="input input-bordered w-full bg-gray-700 border-transparent focus:border-indigo-500"
            />
            {errors.stock && <span className="text-red-400">{errors.stock.message}</span>}
          </div>
          ...
          <div className="form-control">
            ...
            <input
              ...
              className="input input-bordered w-full bg-gray-700 border-transparent focus:border-indigo-500"
            />
            {errors.ratings && <span className="text-red-400">{errors.ratings.message}</span>}
          </div>
          ...
          <div className="form-control mt-6">
            <button type="submit" className="btn btn-primary w-full bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-purple-500 hover:to-indigo-500">
              Create Product
            </button>
          </div>
        </form>
