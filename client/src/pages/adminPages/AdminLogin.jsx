...
export const AdminLoginPage = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse w-full max-w-6xl">
    <div className="card bg-base-100 w-full max-w-md shrink-0 shadow-xl lg:ml-12 p-6 rounded-lg border border-gray-200">
      <form className="card-body space-y-6" onSubmit={handleSubmit(handleLogin)}>
        <h2 className="text-4xl font-extrabold text-center text-gray-800 mb-6">
          Admin Login
        </h2>
        <div className="form-control">
          <label className="label">
            <span className="label-text text-lg font-semibold">Admin Email</span>
          </label>
          <input
            type="email"
        ...
        <div className="form-control">
          <label className="label">
            <span className="label-text text-lg font-semibold">Admin Password</span>
          </label>
          <input
            type="password"
