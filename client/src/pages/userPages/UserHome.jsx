...
//       {/* Welcome Section with Background Image */}
//       <section
//         className="text-center mb-10 bg-cover bg-center relative w-full h-[300px] flex flex-col justify-center items-center text-white"
//         style={{ backgroundImage: 'url("public/images/user_homepage_image.jpg")' }}
//       >
//         {/* Optional Overlay for better text visibility */}
